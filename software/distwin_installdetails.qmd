...
![notwritable](images/d62-notwritable.PNG)
...
![localpkginstall](images/R-install-pkg.PNG)

![chooseRpkg](images/R-install-pkg-dist.PNG)
...
![environmentvariable](images/d62-environmentvariable.PNG)

Following the steps above, you can start Distance again. Attempt to run an MRDS analysis (use the _Golftees.dst_ project shipped with Distance). If all goes as planned, your _Log_ window should produce the following *positive* messages.

![success](images/d62-success.PNG)
